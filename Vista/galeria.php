...
<head>
    ...
    <!-- Page Title -->
    <title>ASTRADOMES-Galería</title>
    ...
    <section>
      ...
      <?php  
        for ($i=0; $i < count($resultado); $i++):
          echo"<li><a href='#img".$i."'><img src=".$resultado[$i][0]."></a></li>";
      ?>
      <?php endfor; ?>
      </ul>
      ...
      <<?php 
        ...
        for ($i=0; $i < count($resultado); $i++):
          echo "<div class='modal' id='img".$i."'>

            <div class='imagen'>
              <a><img src=".$resultado[$i][0]."></a>
            </div>
