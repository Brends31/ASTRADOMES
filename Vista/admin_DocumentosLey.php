            ...
            <div id="page-inner">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <form action="admin_DocumentosLey.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    Nombre del Documento:     <br/> <input type="text" size = "50" name="tituloDocumento"><br>
                    Descripción del Documento: <br/><textarea name="descripcionDocumento" rows="5" cols="50"></textarea><br>
                    Enlace del Documento: <br/><input type="text"  size = "50" name="enlaceDocumento"><br><br>

                    <input class= "btn"  type="submit" name="crearDocumento"  class="submit" value="Crear Documento">
                    </form>
