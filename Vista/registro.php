...
<html lang="en">
<head>
	<title>ASTRADOMES-Registro</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				...
				<form class="login100-form validate-form flex-sb flex-w" method="POST">
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Correo requerido">
					...
					<div class="wrap-input100 validate-input m-b-12" data-validate = "Contraseña requerida">
						<input class="input100" type="password" name="passc" >
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Nombre requerido">
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Apellidos requeridos">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit" formmethod="post" name="registro">
							Registrarse
						</button>
					</div>
