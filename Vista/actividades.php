...
<!-- Mirrored from smartitsource.com/reptro/reptro/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Oct 2018 22:55:29 GMT -->
<head>
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <!-- Page Title -->
    <title>ASTRADOMES-Actividades</title>
...
<body>
                          ...
                          <ul class="nav menu navbar-nav">
                            ...
                            <li class="active"><a href="#">Organización<i class="icofont-simple-down"></i></a>
                              <ul class="dropdown">
                                ...
                                <li class="active"><a href="actividades.php">Actividades</a></li>
    ...
    <!-- Blog List Section -->
    <section id="blog-list" class="section-bg-white pt-100 pb-100">
      <div class="container">
            ...
            <div class='row'>
              ...
              <div class='col-lg-4 col-md-12'>
                <div class='blog-list-thumb'>
                  <img src=".$resultado[0][3]." alt='Img'>
                </div>
              </div>
              <!-- End Col -->
              <!-- Start Col -->
              <div class='col-lg-8 col-md-12  responsive-pt-50 responsive-320'>
                <div class='blog-list-content'>
                  <h3><a href='#'>".$resultado[0][0]."</a></h3>
                  <div class='meta-info'>
                    <ul>
                      <li><span><i class='icofont icofont-user'></i></span><a href='#'>Administrador</a></li>
                      <li><span><i class='icofont icofont-calendar'></i></span><a href='#'>".$resultado[0][2]."</a></li>
                    </ul>
                  </div>
                  <p>".$resultado[0][1]."</p>
                </div>
          ...
          if (count($resultado) > 1) {
            ...
            for($i = 1; $i < count($resultado) ; $i++):
              ...
              <div class='row pt-50'>
                ...
                <div class='col-lg-8 col-md-12  responsive-pt-50 responsive-320'>
                  <div class='blog-list-content'>
                    <h3><a href='#'>".$resultado[$i][0]."</a></h3>
                    <div class='meta-info'>
                      <ul>
                        <li><span><i class='icofont icofont-user'></i></span><a href='#'>Administrador</a></li>
                        <li><span><i class='icofont icofont-calendar'></i></span><a href='#'>".$resultado[$i][2]."</a></li>
                      </ul>
                    </div>
                    <p>".$resultado[$i][1]."</p>
                  </div>
...
<!-- Mirrored from smartitsource.com/reptro/reptro/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Oct 2018 22:55:37 GMT -->
</html>
