...
<head>
    ...
    <title>ASTRADOMES-Admin-Noticias</title>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <h3 style="color:#214775;"> Crear Noticia </h3>
                      ...
                      <form action="admin_Noticias.php" method="post" class="form-signin" enctype="multipart/form-data">
                    Título de la Noticia:     <br/> <input type="text" size = "50" name="TituloNoticia"><br>
                    Descripción de la Noticia: <br/> <textarea name="DescripcionNoticia" rows="5" cols="50"></textarea><br>
                    Enlace de la Noticia: <br/><input type="text"  size = "50" name="EnlaceNoticia"><br>
                    Seleccionar Imagen: <br/><input type="file"  name="ImagenNoticia" type="file" accept='image/*'
                                                    class="uploadFile img" value="Upload Photo"><br>

                    <input class= "btn"  type="submit" name="CrearNoticia"  class="submit" value="Crear Noticia">
                    </form>
                  </div>
