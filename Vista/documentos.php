<?php
    ...
    $resultado = obtenerDocumentos();
?>

<!doctype html>
<html lang="zxx">
    
<!-- Mirrored from smartitsource.com/reptro/reptro/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Oct 2018 22:55:39 GMT -->
<head>
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <!-- Page Title -->
    <title>ASTRADOMES-Documentos</title>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="section-default-title text-center col-12">
            <h2>Documentos</h2>
            <p>Documentos con leyes y temas relevantes para nuestra comunidad</p>
          </div>
        </div>
        <!-- End Row -->
                      ...
                      <div class='col-lg-4 col-md-4 responsive-320'>
                        <div class='blog-item'>
                          <div class='blog-details'>
                            <h3><a href='#'>".$resultado[$indiceDoc][0]."</a></h3>
                            <p>".$resultado[$indiceDoc][1]."</p>
                            <a class='read-more' href='".$resultado[$indiceDoc][2]."'>Ver más <span><i class='icofont-long-arrow-right'></i></span></a>
                            <hr>
                            <div class='meta-info'>
                              <ul>
                                <li><span><i class='icofont icofont-user'></i></span><a href='#'>Administrador</a></li>
                                <li><span><i class='icofont icofont-calendar'></i></span><a href='#'>".$resultado[$indiceDoc][3]."</a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
...
<!-- Mirrored from smartitsource.com/reptro/reptro/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Oct 2018 22:55:52 GMT -->
</html>
