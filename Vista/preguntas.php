...
<!-- Mirrored from smartitsource.com/reptro/reptro/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Oct 2018 22:55:26 GMT -->
<head>
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <!-- Page Title -->
    <title>ASTRADOMES-Preguntas</title>
...
<body>
                          ...
                          <ul class="nav menu navbar-nav">
                            ...
                            <li class="active"><a href="#">Organización<i class="icofont-simple-down"></i></a>
                              <ul class="dropdown">
                                ...
                                <li class="active"><a href="preguntas.php">Preguntas Frecuentes</a></li>
                              </ul>
                            </li>
 ...
 <!--  Question Section  -->
    <section id="project-details" class="section-bg-white  pt-100  pb-100">
      <div class="container">
          <?php

          $columnas = count($preguntas) / 2;
          $sobrantes = count($preguntas) % 2;
          $indicePregunta = 0;

          if(!is_int($columnas)){
              $columnas = intval($columnas += 1);
          }

          for ($i=0; $i < $columnas ; $i++)

          if ($i == $columnas-1 and $sobrantes > 0) {
          echo "<!-- Start Row -->
                    <div class='row pt-45'>";
...
<!-- Mirrored from smartitsource.com/reptro/reptro/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Oct 2018 22:55:29 GMT -->
</html>
